...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
  ...
  private final ViewInfoStore.ProcessCallback mViewInfoProcessCallback =
      new ViewInfoStore.ProcessCallback() {
        ...
        public void processAppeared(ViewHolder viewHolder,
                                    RecyclerView.ItemAnimator.ItemHolderInfo preInfo, RecyclerView.ItemAnimator.ItemHolderInfo info) {
        ...
        public void unused(ViewHolder viewHolder) {
          mLayoutManager.removeAndRecycleView(viewHolder.itemView, mRecycler);
        }
      };
      ...
      void dispatchUpdate(AdapterHelper.UpdateOp op) {
        switch (op.cmd) {
          case AdapterHelper.UpdateOp.ADD:
            mLayoutManager.onItemsAdded(RecyclerView.this, op.positionStart, op.itemCount);
            break;
          case AdapterHelper.UpdateOp.REMOVE:
            mLayoutManager.onItemsRemoved(RecyclerView.this, op.positionStart, op.itemCount);
            break;
          case AdapterHelper.UpdateOp.UPDATE:
            mLayoutManager.onItemsUpdated(RecyclerView.this, op.positionStart, op.itemCount,
                op.payload);
            break;
          case AdapterHelper.UpdateOp.MOVE:
            mLayoutManager.onItemsMoved(RecyclerView.this, op.positionStart, op.itemCount, 1);
            break;
        }
      }
  ...
  private void setAdapterInternal(Adapter adapter, boolean compatibleWithPrevious,
    ...
    if (!compatibleWithPrevious || removeAndRecycleViews) {
      ...
      // Since animations are ended, mLayoutManager.children should be equal to
      // recyclerView.children. This may not be true if item animator's end does not work as
      // expected. (e.g. not release children instantly). It is safer to use mLayoutManager's child
      // count.
    ...
    if (mLayoutManager != null) {
      mLayoutManager.onAdapterChanged(oldAdapter, mAdapter);
    }
  ...
  public void setLayoutManager(LayoutManager layout) {
    ...
    if (mLayoutManager != null) {
      ...
      mLayoutManager.setRecyclerView(null);
    }
    mRecycler.clear();
    ...
    if (layout != null) {
      ...
      mLayoutManager.setRecyclerView(this);
      if (mIsAttached) {
  ...
  protected void onRestoreInstanceState(Parcelable state) {
    ...
    if (mLayoutManager != null && mPendingSavedState.mLayoutState != null) {
      mLayoutManager.onRestoreInstanceState(mPendingSavedState.mLayoutState);
    }
  }
  ...
  public void addItemDecoration(ItemDecoration decor, int index) {
    if (mLayoutManager != null) {
      mLayoutManager.assertNotInLayoutOrScroll("Cannot add item decoration during a scroll  or"
          + " layout");
    }
  ...
  public void removeItemDecoration(ItemDecoration decor) {
    if (mLayoutManager != null) {
      mLayoutManager.assertNotInLayoutOrScroll("Cannot remove item decoration during a scroll  or"
          + " layout");
    }
  ...
  public void smoothScrollToPosition(int position) {
    ...
    mLayoutManager.smoothScrollToPosition(this, mState, position);
  }
  ...
  public void scrollBy(int x, int y) {
    ...
    final boolean canScrollHorizontal = mLayoutManager.canScrollHorizontally();
    final boolean canScrollVertical = mLayoutManager.canScrollVertically();
  ...
  public int computeHorizontalScrollOffset() {
    ...
    return mLayoutManager.canScrollHorizontally() ? mLayoutManager.computeHorizontalScrollOffset(mState) : 0;
  }
  ...
  public int computeHorizontalScrollExtent() {
    ...
    return mLayoutManager.canScrollHorizontally() ? mLayoutManager.computeHorizontalScrollExtent(mState) : 0;
  }
  ...
  public int computeHorizontalScrollRange() {
    ...
    return mLayoutManager.canScrollHorizontally() ? mLayoutManager.computeHorizontalScrollRange(mState) : 0;
  }
  ...
  public int computeVerticalScrollOffset() {
    ...
    return mLayoutManager.canScrollVertically() ? mLayoutManager.computeVerticalScrollOffset(mState) : 0;
  }
  ...
  public int computeVerticalScrollExtent() {
    ...
    return mLayoutManager.canScrollVertically() ? mLayoutManager.computeVerticalScrollExtent(mState) : 0;
  }
  ...
  public int computeVerticalScrollRange() {
    ...
    return mLayoutManager.canScrollVertically() ? mLayoutManager.computeVerticalScrollRange(mState) : 0;
  }
  ...
  void resumeRequestLayout(boolean performLayoutChildren) {
    ...
    if (mEatRequestLayout == 1) {
      ...
      if (performLayoutChildren && mLayoutRequestEaten && !mLayoutFrozen &&
          mLayoutManager != null && mAdapter != null) {
        dispatchLayout();
      }
      if (!mLayoutFrozen) {
        mLayoutRequestEaten = false;
  ...
  public View focusSearch(View focused, int direction) {
    View result = mLayoutManager.onInterceptFocusSearch(focused, direction);
    if (result != null) {
      return result;
    }
    final FocusFinder ff = FocusFinder.getInstance();
    result = ff.findNextFocus(this, focused, direction);
    if (result == null && mAdapter != null && mLayoutManager != null && !isComputingLayout()
        && !mLayoutFrozen) {
      eatRequestLayout();
      result = mLayoutManager.onFocusSearchFailed(focused, direction, mRecycler, mState);
      resumeRequestLayout(false);
    }
  ...
  public void requestChildFocus(View child, View focused) {
    if (!mLayoutManager.onRequestChildFocus(this, mState, child, focused) && focused != null) {
  ...
  public boolean requestChildRectangleOnScreen(View child, Rect rect, boolean immediate) {
    return mLayoutManager.requestChildRectangleOnScreen(this, child, rect, immediate);
  }

  @Override
  public void addFocusables(ArrayList<View> views, int direction, int focusableMode) {
    if (mLayoutManager == null || !mLayoutManager.onAddFocusables(this, views, direction, focusableMode)) {
  ...
  protected void onMeasure(int widthSpec, int heightSpec) {
    ...
    if (mLayoutManager.mAutoMeasure) {
      final int widthMode = MeasureSpec.getMode(widthSpec);
      final int heightMode = MeasureSpec.getMode(heightSpec);
      final boolean skipMeasure = widthMode == MeasureSpec.EXACTLY
          && heightMode == MeasureSpec.EXACTLY;
      mLayoutManager.onMeasure(mRecycler, mState, widthSpec, heightSpec);
      ...
      // consistency
      mLayoutManager.setMeasureSpecs(widthSpec, heightSpec);
      mState.mIsMeasuring = true;
      dispatchLayoutStep2();

      // now we can get the width and height from the children.
      mLayoutManager.setMeasuredDimensionFromChildren(widthSpec, heightSpec);

      // if RecyclerView has non-exact width and height and if there is at least one child
      // which also has non-exact width & height, we have to re-measure.
      if (mLayoutManager.shouldMeasureTwice()) {
        mLayoutManager.setMeasureSpecs(
  ...
  private boolean predictiveItemAnimationsEnabled() {
    return (mItemAnimator != null && mLayoutManager.supportsPredictiveItemAnimations());
  }
  ...
  private void processAdapterUpdatesAndSetAnimationFlags() {
    ...
    mState.mRunSimpleAnimations = mFirstLayoutComplete && mItemAnimator != null &&
        (mDataSetHasChangedAfterLayout || animationTypeSupported ||
            mLayoutManager.mRequestedSimpleAnimations) &&
  ...
  void dispatchLayout() {
    ...
    if (mState.mLayoutStep == State.STEP_START) {
      ...
      dispatchLayoutStep2();
    } else if (mAdapterHelper.hasUpdates() || mLayoutManager.getWidth() != getWidth() ||
        mLayoutManager.getHeight() != getHeight()) {
  ...
  protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
    return p instanceof LayoutParams && mLayoutManager.checkLayoutParams((LayoutParams) p);
  }
  ...
  public void invalidateItemDecorations() {
    ...
    if (mLayoutManager != null) {
      mLayoutManager.assertNotInLayoutOrScroll("Cannot invalidate item decorations during a scroll"
          + " or layout");
    }
    markItemDecorInsetsDirty();
    requestLayout();
  ...
  private class ViewFlinger implements Runnable {
    ...
    public void run() {
      ...
      final SmoothScroller smoothScroller = mLayoutManager.mSmoothScroller;
      if (scroller.computeScrollOffset()) {
        ...
        if (mAdapter != null) {
          ...
          TraceCompat.beginSection(TRACE_SCROLL_TAG);
          if (dx != 0) {
            hresult = mLayoutManager.scrollHorizontallyBy(dx, mRecycler, mState);
            overscrollX = dx - hresult;
          }
          if (dy != 0) {
            vresult = mLayoutManager.scrollVerticallyBy(dy, mRecycler, mState);
        ...
        final boolean fullyConsumedVertical = dy != 0 && mLayoutManager.canScrollVertically()
            && vresult == dy;
        final boolean fullyConsumedHorizontal = dx != 0 && mLayoutManager.canScrollHorizontally()
            && hresult == dx;
